...
from marty_backend_common.testing import (  # Core utilities; Enhanced fixtures; Service-specific config
    CommonTestData,
    MockFactory,
...
from marty_backend_common.testing import PKDServiceTestConfig, test_data_factory
from app.main import app as pkd_app
