...
def _trust_profile_to_response(profile) -> TrustProfileResponse:
    ...
    return TrustProfileResponse(
        ...
        allowed_formats=[f.value for f in profile.allowed_formats],
        revocation_policy={
            "mode": profile.revocation_policy.mode.value,
        ...
        time_policy={
            "clock_skew_tolerance_seconds": profile.time_policy.clock_skew_tolerance.total_seconds(),
            "require_not_before": profile.time_policy.require_not_before,
            "require_not_after": profile.time_policy.require_not_after,
        },
