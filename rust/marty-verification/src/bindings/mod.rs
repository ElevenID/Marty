...
fn verify_signature(
    ...
    crate::crypto::verify_signature(alg, public_key_der, message, signature)
        .map_err(|e| PyErr::from(e))
}
...
fn load_certificate_pem<'py>(py: Python<'py>, pem_data: &str) -> PyResult<Bound<'py, PyBytes>> {
    let der =
        crate::crypto::certificate::load_certificate_pem(pem_data).map_err(|e| PyErr::from(e))?;
...
fn load_certificate_der<'py>(py: Python<'py>, der_data: &[u8]) -> PyResult<Bound<'py, PyBytes>> {
    let _cert =
        crate::crypto::certificate::load_certificate_der(der_data).map_err(|e| PyErr::from(e))?;
...
fn get_certificate_info<'py>(py: Python<'py>, der_data: &[u8]) -> PyResult<Bound<'py, PyDict>> {
    let info =
        crate::crypto::certificate::get_certificate_info(der_data).map_err(|e| PyErr::from(e))?;
...
fn certificate_pem_to_der<'py>(py: Python<'py>, pem_data: &str) -> PyResult<Bound<'py, PyBytes>> {
    let der = crate::crypto::certificate::pem_to_der(pem_data).map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &der))
}
...
fn certificate_der_to_pem(der_data: &[u8]) -> PyResult<String> {
    crate::crypto::certificate::der_to_pem(der_data).map_err(|e| PyErr::from(e))
}
...
fn get_certificate_public_key<'py>(
    ...
    let pubkey = crate::crypto::certificate::get_certificate_public_key(der_data)
        .map_err(|e| PyErr::from(e))?;
...
fn is_certificate_expired(der_data: &[u8]) -> PyResult<bool> {
    crate::crypto::certificate::is_certificate_expired(der_data).map_err(|e| PyErr::from(e))
}

/// Check if a certificate is not yet valid.
#[pyfunction]
fn is_certificate_not_yet_valid(der_data: &[u8]) -> PyResult<bool> {
    crate::crypto::certificate::is_certificate_not_yet_valid(der_data).map_err(|e| PyErr::from(e))
}
...
fn verify_certificate_signature(cert_der: &[u8], issuer_der: &[u8]) -> PyResult<bool> {
    crate::crypto::certificate::verify_certificate_signature(cert_der, issuer_der)
        .map_err(|e| PyErr::from(e))
}
...
fn load_private_key_pem<'py>(py: Python<'py>, pem_data: &str) -> PyResult<Bound<'py, PyBytes>> {
    let der =
        crate::crypto::serialization::load_private_key_pem(pem_data).map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &der))
}
...
fn load_private_key_der<'py>(py: Python<'py>, der_data: &[u8]) -> PyResult<Bound<'py, PyBytes>> {
    let der =
        crate::crypto::serialization::load_private_key_der(der_data).map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &der))
}
...
fn save_private_key_pem(private_key_der: &[u8]) -> PyResult<String> {
    crate::crypto::serialization::save_private_key_pem(private_key_der).map_err(|e| PyErr::from(e))
}
...
fn load_public_key_pem<'py>(py: Python<'py>, pem_data: &str) -> PyResult<Bound<'py, PyBytes>> {
    let der =
        crate::crypto::serialization::load_public_key_pem(pem_data).map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &der))
}
...
fn load_public_key_der<'py>(py: Python<'py>, der_data: &[u8]) -> PyResult<Bound<'py, PyBytes>> {
    let der =
        crate::crypto::serialization::load_public_key_der(der_data).map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &der))
}
...
fn save_public_key_pem(public_key_der: &[u8]) -> PyResult<String> {
    crate::crypto::serialization::save_public_key_pem(public_key_der).map_err(|e| PyErr::from(e))
}
...
fn extract_public_key<'py>(
    ...
    let pubkey = crate::crypto::serialization::extract_public_key(private_key_der)
        .map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &pubkey))
}
...
fn detect_private_key_type(der_data: &[u8]) -> PyResult<String> {
    crate::crypto::serialization::detect_private_key_type(der_data).map_err(|e| PyErr::from(e))
}

/// Detect the type of a public key.
#[pyfunction]
fn detect_public_key_type(der_data: &[u8]) -> PyResult<String> {
    crate::crypto::serialization::detect_public_key_type(der_data).map_err(|e| PyErr::from(e))
}

/// Get the key size in bits.
#[pyfunction]
fn get_key_size(public_key_der: &[u8]) -> PyResult<usize> {
    crate::crypto::serialization::get_key_size(public_key_der).map_err(|e| PyErr::from(e))
}
...
fn raw_private_key_to_pkcs8<'py>(
    ...
    let der = crate::crypto::serialization::raw_private_key_to_pkcs8(raw_key, key_type)
        .map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &der))
}
...
fn raw_public_key_to_spki<'py>(
    ...
    let der = crate::crypto::serialization::raw_public_key_to_spki(raw_key, key_type)
        .map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &der))
}
...
fn pkcs8_to_raw_private_key<'py>(
    ...
    let (raw, key_type) = crate::crypto::serialization::pkcs8_to_raw_private_key(pkcs8_der)
        .map_err(|e| PyErr::from(e))?;
...
fn spki_to_raw_public_key<'py>(
    ...
    let (raw, key_type) = crate::crypto::serialization::spki_to_raw_public_key(spki_der)
        .map_err(|e| PyErr::from(e))?;
    Ok((PyBytes::new(py, &raw), key_type))
}
...
fn hkdf_sha256<'py>(
    ...
    let result =
        crate::crypto::kdf::hkdf_sha256(ikm, salt, info, length).map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &result))
}
...
fn hkdf_sha384<'py>(
    ...
    let result =
        crate::crypto::kdf::hkdf_sha384(ikm, salt, info, length).map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &result))
}
...
fn pbkdf2_sha256<'py>(
    ...
    let result = crate::crypto::kdf::pbkdf2_sha256(password, salt, iterations, key_length);
    Ok(PyBytes::new(py, &result))
}
...
fn aes_gcm_encrypt<'py>(
    ...
    let result = match key.len() {
        16 => crate::crypto::symmetric::aes_128_gcm_encrypt(key, nonce, plaintext, aad),
        32 => crate::crypto::symmetric::aes_256_gcm_encrypt(key, nonce, plaintext, aad),
        _ => {
...
fn aes_gcm_decrypt<'py>(
    ...
    let result = match key.len() {
        16 => crate::crypto::symmetric::aes_128_gcm_decrypt(key, nonce, ciphertext, aad),
        32 => crate::crypto::symmetric::aes_256_gcm_decrypt(key, nonce, ciphertext, aad),
        _ => {
            return Err(pyo3::exceptions::PyValueError::new_err(
                "Key must be 16 bytes (AES-128) or 32 bytes (AES-256)",
            ))
...
fn tdes_cbc_encrypt<'py>(
    ...
    let result = crate::crypto::des::tdes_cbc_encrypt_padded(key, iv, plaintext)
        .map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &result))
}
...
fn tdes_cbc_decrypt<'py>(
    ...
    let result = crate::crypto::des::tdes_cbc_decrypt_padded(key, iv, ciphertext)
        .map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &result))
}
...
fn ed25519_generate<'py>(py: Python<'py>) -> PyResult<(Bound<'py, PyBytes>, Bound<'py, PyBytes>)> {
    let (secret, public) = crate::crypto::ed25519::generate_keypair();
...
fn ed25519_sign<'py>(
    ...
    let signature =
        crate::crypto::ed25519::sign(secret_key, message).map_err(|e| PyErr::from(e))?;
...
fn ed25519_verify(public_key: &[u8], message: &[u8], signature: &[u8]) -> PyResult<bool> {
    Ok(crate::crypto::ed25519::verify_bool(
...
fn x25519_generate<'py>(py: Python<'py>) -> PyResult<(Bound<'py, PyBytes>, Bound<'py, PyBytes>)> {
    let (secret, public) = crate::crypto::ecdh::x25519_generate_keypair();
    Ok((PyBytes::new(py, &secret), PyBytes::new(py, &public)))
}
...
fn x25519_agree<'py>(
    ...
    let keypair = crate::crypto::ecdh::X25519KeyPair::from_secret_key(secret_key)
        .map_err(|e| PyErr::from(e))?;
...
fn p256_generate<'py>(py: Python<'py>) -> PyResult<(Bound<'py, PyBytes>, Bound<'py, PyBytes>)> {
    let (secret, public) = crate::crypto::ecdh::p256_generate_keypair();
    Ok((PyBytes::new(py, &secret), PyBytes::new(py, &public)))
}
...
fn p256_agree<'py>(
    ...
    let result =
        crate::crypto::ecdh::p256_agree(secret_key, peer_public).map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &result))
}
...
fn ecdsa_p256_generate<'py>(
    ...
    let (secret, public) =
        crate::crypto::ecdsa::generate_p256_keypair().map_err(|e| PyErr::from(e))?;
    Ok((PyBytes::new(py, &secret), PyBytes::new(py, &public)))
}
...
fn ecdsa_p384_generate<'py>(
    ...
    let (secret, public) =
        crate::crypto::ecdsa::generate_p384_keypair().map_err(|e| PyErr::from(e))?;
    Ok((PyBytes::new(py, &secret), PyBytes::new(py, &public)))
}
...
fn ecdsa_p256_sign<'py>(
    ...
    let signature =
        crate::crypto::ecdsa::sign_p256_sha256(secret_key, message).map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &signature))
}
...
fn ecdsa_p384_sign<'py>(
    ...
    let signature =
        crate::crypto::ecdsa::sign_p384_sha384(secret_key, message).map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &signature))
}
...
fn ecdsa_p256_verify(public_key: &[u8], message: &[u8], signature: &[u8]) -> PyResult<bool> {
    crate::crypto::ecdsa::verify_p256_sha256(public_key, message, signature)
        .map_err(|e| PyErr::from(e))
}
...
fn ecdsa_p384_verify(public_key: &[u8], message: &[u8], signature: &[u8]) -> PyResult<bool> {
    crate::crypto::ecdsa::verify_p384_sha384(public_key, message, signature)
        .map_err(|e| PyErr::from(e))
}
...
fn rsa_generate<'py>(
    ...
    let (private_der, public_der) =
        crate::crypto::rsa::generate_rsa_keypair(bits).map_err(|e| PyErr::from(e))?;
    Ok((
...
fn rsa_pkcs1_sha256_sign<'py>(
    ...
    let signature = crate::crypto::rsa::sign_pkcs1_sha256(private_key_der, message)
        .map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &signature))
}
...
fn rsa_pkcs1_sha384_sign<'py>(
    ...
    let signature = crate::crypto::rsa::sign_pkcs1_sha384(private_key_der, message)
        .map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &signature))
}
...
fn rsa_pkcs1_sha512_sign<'py>(
    ...
    let signature = crate::crypto::rsa::sign_pkcs1_sha512(private_key_der, message)
        .map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &signature))
}
...
fn rsa_pss_sha256_sign<'py>(
    ...
    let signature = crate::crypto::rsa::sign_pss_sha256(private_key_der, message)
        .map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &signature))
}
...
fn rsa_pss_sha384_sign<'py>(
    ...
    let signature = crate::crypto::rsa::sign_pss_sha384(private_key_der, message)
        .map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &signature))
}
...
fn rsa_pss_sha512_sign<'py>(
    ...
    let signature = crate::crypto::rsa::sign_pss_sha512(private_key_der, message)
        .map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &signature))
}
...
fn rsa_pkcs1_sha256_verify(
    ...
    crate::crypto::rsa::verify_pkcs1_sha256(public_key_der, message, signature)
        .map_err(|e| PyErr::from(e))
}
...
fn rsa_pkcs1_sha384_verify(
    ...
    crate::crypto::rsa::verify_pkcs1_sha384(public_key_der, message, signature)
        .map_err(|e| PyErr::from(e))
}
...
fn rsa_pkcs1_sha512_verify(
    ...
    crate::crypto::rsa::verify_pkcs1_sha512(public_key_der, message, signature)
        .map_err(|e| PyErr::from(e))
}
...
fn rsa_pss_sha256_verify(
    ...
    crate::crypto::rsa::verify_pss_sha256(public_key_der, message, signature)
        .map_err(|e| PyErr::from(e))
}
...
fn rsa_pss_sha384_verify(
    ...
    crate::crypto::rsa::verify_pss_sha384(public_key_der, message, signature)
        .map_err(|e| PyErr::from(e))
}
...
fn rsa_pss_sha512_verify(
    ...
    crate::crypto::rsa::verify_pss_sha512(public_key_der, message, signature)
        .map_err(|e| PyErr::from(e))
}
...
fn generate_random_bytes<'py>(py: Python<'py>, length: usize) -> Bound<'py, PyBytes> {
    let bytes = crate::crypto::keygen::generate_random_bytes(length);
...
fn generate_key<'py>(
    ...
    use crate::crypto::keygen::{generate_keypair, KeyType};
...
fn ed448_generate<'py>(py: Python<'py>) -> PyResult<(Bound<'py, PyBytes>, Bound<'py, PyBytes>)> {
    let (private_key, public_key) =
        crate::crypto::ed448::ed448_generate().map_err(|e| PyErr::from(e))?;
    Ok((
...
fn ed448_sign<'py>(
    ...
    let signature =
        crate::crypto::ed448::ed448_sign(private_key, message).map_err(|e| PyErr::from(e))?;
    Ok(PyBytes::new(py, &signature))
}
...
fn ed448_verify(public_key: &[u8], message: &[u8], signature: &[u8]) -> PyResult<bool> {
    crate::crypto::ed448::ed448_verify(public_key, message, signature).map_err(|e| PyErr::from(e))
}
...
fn pkcs12_parse(data: &[u8], password: &str) -> PyResult<PyPkcs12Data> {
    let parsed = crate::crypto::pkcs12::parse_pkcs12(data, password).map_err(|e| PyErr::from(e))?;
...
fn iso9796_verify(
    ...
    use crate::crypto::iso9796::{Iso9796HashAlgorithm, Iso9796Scheme};
    ...
    crate::crypto::iso9796::iso9796_verify(public_key_der, message, signature, scheme, hash_alg)
        .map_err(|e| PyErr::from(e))
}
...
fn iso9796_recover<'py>(
    ...
    let recovered = crate::crypto::iso9796::iso9796_recover_message(
        public_key_der,
        signature,
        scheme,
        hash_alg,
...
fn build_ocsp_request<'py>(
    ...
    let request = crate::crypto::ocsp::build_ocsp_request(cert_der, issuer_cert_der)
        .map_err(|e| PyErr::from(e))?;
...
fn get_ocsp_responder_url(cert_der: &[u8]) -> PyResult<Option<String>> {
    crate::crypto::ocsp::get_ocsp_responder_url(cert_der).map_err(|e| PyErr::from(e))
}
...
fn parse_ocsp_response(py: Python<'_>, response_der: &[u8]) -> PyResult<Py<PyDict>> {
    let info =
        crate::crypto::ocsp::parse_ocsp_response(response_der).map_err(|e| PyErr::from(e))?;
    ...
    if let Some(status) = info.cert_status {
        match status {
            crate::crypto::ocsp::OcspCertStatus::Good => {
                dict.set_item("cert_status", "good")?;
            }
            crate::crypto::ocsp::OcspCertStatus::Revoked {
                revocation_time,
                reason,
            } => {
            ...
            crate::crypto::ocsp::OcspCertStatus::Unknown => {
...
pub struct PyCertProfile {
    inner: crate::crypto::cert_builder::CertProfile,
}
...
impl PyCertProfile {
    ...
    fn ca(path_length: Option<u8>) -> Self {
        Self {
            inner: crate::crypto::cert_builder::CertProfile::Ca { path_length },
        }
    }
    ...
    fn sub_ca(path_length: u8) -> Self {
        Self {
            inner: crate::crypto::cert_builder::CertProfile::SubCa { path_length },
        }
    }
    ...
    fn end_entity() -> Self {
        Self {
            inner: crate::crypto::cert_builder::CertProfile::EndEntity,
        }
    }
    ...
    fn csca(country_code: &str) -> Self {
        Self {
            inner: crate::crypto::cert_builder::CertProfile::Csca {
    ...
    fn iaca(jurisdiction: &str) -> Self {
        Self {
            inner: crate::crypto::cert_builder::CertProfile::Iaca {
    ...
    fn dsc(country_code: &str) -> Self {
        Self {
            inner: crate::crypto::cert_builder::CertProfile::Dsc {
                country_code: country_code.to_string(),
            },
        }
    }
...
pub struct PyCertificateBuilderConfig {
    ...
    validity_days: u32,
    profile: crate::crypto::cert_builder::CertProfile,
    key_type: String,
}
...
impl PyCertificateBuilderConfig {
    ...
    fn new() -> Self {
        Self {
            ...
            issuer_cn: None,
            validity_days: 365,
            profile: crate::crypto::cert_builder::CertProfile::EndEntity,
    ...
    fn build_self_signed<'py>(&self, py: Python<'py>) -> PyResult<(Bound<'py, PyBytes>, String)> {
        use crate::crypto::cert_builder::{CertificateBuilderConfig, DistinguishedName};
        use crate::crypto::keygen::KeyType;
...
fn build_self_signed_certificate<'py>(
    ...
    use crate::crypto::cert_builder::{CertProfile, CertificateBuilderConfig, DistinguishedName};
    use crate::crypto::keygen::KeyType;
