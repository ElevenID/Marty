...
# Disable SSL warnings only in development when VERIFY_SSL is explicitly disabled
if os.environ.get("OPENXPKI_VERIFY_SSL", "true").lower() == "false":
...
class BaseOpenXPKIService:
    ...
    def __init__(self) -> None:
        ...
        self.verify_ssl = os.environ.get("OPENXPKI_VERIFY_SSL", "true").lower() != "false"
