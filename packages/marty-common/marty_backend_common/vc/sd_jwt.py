...
from marty_plugin.common.infrastructure import KeyVaultClient

from marty_backend_common.utils.base64_utils import b64url_encode as _b64url_encode
    ...
    def _build_x5c_chain(self) -> list[str]:
        ...
        for certificate in chain:
            try:
                ...
                continue
            # x5c entries use standard base64 per RFC 7515 §4.1.6
            x5c_entries.append(base64.b64encode(der_bytes).decode("ascii"))
        return x5c_entries
