...
Usage:
    from marty_backend_common.crypto_bridge import verify_jwt, generate_did_key
    from marty_backend_common.crypto_bridge import open_badge_ob2_issue, parse_mrz
"""
...
try:
    ...
    build_ocsp_request = None
    get_ocsp_responder_url = None
    parse_ocsp_response = None
...
__all__ = [
    ...
    'verify_signature',
    'hash_data',
    # CRL/OCSP operations (marty-verification)
    'parse_crl',
    'check_certificate_revocation',
    'build_ocsp_request',
    'get_ocsp_responder_url',
